...
class Portfolio(Base):
    ...
    bots = relationship("Bot", back_populates="portfolio", cascade="all, delete-orphan")
...
class PortfolioHistory(Base):
    ...
    unrealized_pnl = Column(Numeric(20, 2), nullable=False, default=0)
    margin_level = Column(Numeric(20, 4), nullable=False, default=0)      
...
class PortfolioDailySnapshot(Base):
    ...
    margin_level = Column(Numeric(20, 4), nullable=True)  # FIXED    
    # Ranking
